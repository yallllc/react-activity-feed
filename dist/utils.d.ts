...
export declare const smartRender: (ElementOrComponentOrLiteral: Renderable, props?: any, fallback?: Renderable) => string | number | boolean | React.Component<any, {}, any> | import("./types").ReactComponentFunction | JSX.Element;
